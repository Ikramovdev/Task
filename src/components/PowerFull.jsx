...
const PowerFull = () => {
    ...
    return (
        <section id='about'>
            <div className='w-md lg:w-[1110px] powerContainer mx-5 lg:mx-auto py-[110px] flex items-center justify-between'>
                <div data-aos="fade-right" className='my-5 lg:my-[50px]'>
                    <div className='mb-[50px] md:mb-[80px] w-full md:w-[350px] lg:w-[540px] text-center md:text-left'>
                        ...
                        <p className='font-regular text-[15px] lg:text-[16px] leading-[23px] md:leading-[20px] lg:leading-[26px] text-[#6F7CB2]'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim.</p>
                    </div>
                    <ul className='md:flex md:items-center space-y-[20px] md:space-y-0  md:gap-[30px]'>
                        <li className='item w-full md:w-[170px] lg:mx-auto text-center md:text-left lg:w-[255px]'>
                            <div><PowerItem1/></div>
                            <h3 className='font-medium text-[20px] md:text-[17px] lg:text-[16px] leading-[26px] text-[#091133] mb-[6px] mt-[14px]'>Title Goes Here</h3>
                            <p className='font-regular text-[15.5px] md:text-[12px] lg:text-[13px] leading-[18px] text-[#5D6970]'>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. </p>
                        </li>
                        <li className='item w-full md:w-[170px] lg:mx-auto text-center md:text-left lg:w-[255px]'>
                            <div><PowerItem1/></div>
                            <h3 className='font-medium text-[20px] md:text-[17px] lg:text-[16px] leading-[26px] text-[#091133] mb-[6px] mt-[14px]'>Title Goes Here</h3>
